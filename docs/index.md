...
## 部署流程
1. 访问LiteLLM社区版服务[部署链接](https://computenest.console.aliyun.com/service/instance/create/cn-hangzhou?type=user&ServiceId=service-d57bfd6e5c724304bf55)，选择**新建ECS部署**，按提示填写部署参数：
    ![image.png](img.png)
